...
import com.sam43.imageloader.utilities.NetworkUtils.getRequestFailReason
import okhttp3.Call
...
internal class HttpOperationWrapper {
    ...
    private fun enqueueRequest() = call.enqueue(object : Callback {
        override fun onFailure(
            ...
            this@HttpOperationWrapper.httpCallbacks.onResponse(
                call = call,
                error = getRequestFailReason(throwable = e)
            )
        }
